...
//ParamsOfSendMessage
public struct TSDKParamsOfSendMessage: Decodable {
    var message: String
    var abi: TSDKAbiData?
...
public struct TSDKParamsOfWaitForTransaction: Decodable {
    var abi: TSDKAbiData?
    var message: String
    var shard_block_id: String
    var send_events: Bool
...
public struct TSDKParamsOfProcessMessage: Decodable {
